...
<div id="<?php echo esc_attr($uid); ?>" class="bc-wrap">
    <div class="bc-container">
        <h3 class="heading">Browse all courses</h3>
        ...
        <div class="bc-grid">
            ...
            <aside class="bc-sidebar">
                <div class="bc-fgroup" data-group="ratings">
                    ...
                    <div class="bc-fbody">
                        <label class="bc-check"><input type="checkbox" name="rating" value="4.5"> 4.5 &amp; up</label>
                        <label class="bc-check"><input type="checkbox" name="rating" value="4"> 4.0 &amp; up</label>
                        <label class="bc-check"><input type="checkbox" name="rating" value="3.5"> 3.5 &amp; up</label>
                ...
                <div class="bc-fgroup" data-group="outcomes">
                    ...
                    <div class="bc-fbody">
                        <label class="bc-check"><input type="checkbox" name="outcomes" value="Improved skills"> Improved
                            skills</label>
                        ...
                        <label class="bc-check"><input type="checkbox" name="outcomes" value="Career boost"> Career
                            boost</label>
                        <label class="bc-check"><input type="checkbox" name="outcomes" value="Gained confidence"> Gained
                            confidence</label>
                ...
                <div class="bc-fgroup" data-group="level">
                    ...
                    <div class="bc-fbody">
                        <label class="bc-check"><input type="checkbox" name="level" value="Beginner"> Beginner</label>
                        <label class="bc-check"><input type="checkbox" name="level" value="Intermediate">
                            Intermediate</label>
                        <label class="bc-check"><input type="checkbox" name="level" value="Advanced"> Advanced</label>
                    </div>
                </div>
                ...
                <div class="bc-fgroup" data-group="duration">
                    ...
                    <div class="bc-fbody">
                        ...
                        <label class="bc-check"><input type="checkbox" name="duration" value="1-3"> 1–3 Hours</label>
                        <label class="bc-check"><input type="checkbox" name="duration" value="3-6"> 3–6 Hours</label>
                        <label class="bc-check"><input type="checkbox" name="duration" value="6-17"> 6–17 Hours</label>
                        <label class="bc-check"><input type="checkbox" name="duration" value="17+"> 17+ Hours</label>
                    </div>
                </div>
            </aside>
