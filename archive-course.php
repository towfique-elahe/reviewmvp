<?php
/**
 * Template: Course Archive
 * Works at: the archive URL defined by has_archive (e.g. /courses/)
 */
get_header();

$uid = uniqid('bc_'); // optional, but keeps your JS selectors unique
?>
        ...
        <div class="bc-head">
            <h3 class="bc-heading">
                ...
                echo isset($_GET['c']) && $_GET['c'] !== ''
                    ? 'Search results for "' . esc_html($_GET['c']) . '"'
                    : 'Browse all courses';
                ?>
            </h3>
